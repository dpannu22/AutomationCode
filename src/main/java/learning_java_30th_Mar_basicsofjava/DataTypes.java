...
public class DataTypes {
	...
	long s2 = 9,223,372,036,854,775,807
	...
	boolean b12 = false //false is a condition
	
	boolean b13 = 1<2 //this is also be a condition
	...
	//String is the God of all Classes
			
	String s1 = "Hello World";
	String s2 = new String("Hello World");
	
	//Array - [] is one dimension, [][] is two dimension
